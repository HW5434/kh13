...
import com.kh.spring10integrated.dao.AttachDao;
import com.kh.spring10integrated.dao.ItemDao;
...
public class AdminItemController {
	...
	//application.properties에 몇가지 설정을 한 뒤 자연스럽게 수신이 가능하다
...
//			System.out.println("iemName = " + itemName);
...
//		충전상품 등록
		...
		if(!attach.isEmpty()) {
			System.out.println("파일명 = " + attach.getOriginalFilename());//사용자가 올린 파일명
