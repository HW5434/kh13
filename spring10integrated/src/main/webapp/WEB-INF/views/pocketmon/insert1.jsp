...
<%--
	생성해야 하는 주소 형태
	http://locakhost:8080/pocketmon/insert2
        ...
        <div class="container w-400">
            ...
            <div class="cell">
                ...
                <input type="text" name="pocketmonNo" 
                            placeholder="(ex) 1" class="tool w-100" onblur="checkPocketmonNo();">
            ...
            <div class="cell">
                ...
                <input type="text" name="pocketmonName" 
                                    placeholder="(ex) 이상해씨" class="tool w-100" onblur="checkPocketmonName();">
                <div class="fail-feedback">이름을 반드시 입력하세요</div>
            </div>
            <div class="cell">
                <label>
                    속성
