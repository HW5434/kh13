...
<div class="container w-800">
	...
	<div class="cell">
		<textarea class="tool w-100 reply-editor" style="min-height: 100px;" placeholder="댓글 내용을 입력하세요"></textarea>
		<div class="cell">
			<button class="btn w-100 btn-reply-insert">
