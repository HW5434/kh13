...
public class GroupWebSocketServer extends TextWebSocketHandler{
	...
	//private Set<WebSocketSession> users = Collections.synchronizedSet(new); //동기화 안됨(자물쇠 없음)
	private Set<WebSocketSession> users = new CopyOnWriteArraySet<>(); //동기화 안됨(자물쇠 없음)
