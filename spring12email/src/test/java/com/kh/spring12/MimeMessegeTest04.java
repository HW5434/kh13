...
@Slf4j
@SpringBootTest
public class MimeMessegeTest04 {
	...
	public void test() throws MessagingException, IOException {
		...
		//첨부파일 추가
		ClassPathResource attach1 = new ClassPathResource("static/image/airplane.png");
		ClassPathResource attach2 = new ClassPathResource("static/image/test.png");
		ClassPathResource attach3 = new ClassPathResource("static/image/user.png");
